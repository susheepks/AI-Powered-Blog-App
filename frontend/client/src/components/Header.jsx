  ...
  return (
    <div className="mx-8 sm:mx-16 xl:mx-24 relative">
        <div className="text-center mt-20 mb-8">
          ...
          border vorder-primary/40 bg-primary/10 rounded-full text-sm text-primary'>
            <p>new AI integrated BlogPage</p>
            <img src={assets.star_icon} alt="" className='w-2.5' />
          </div>

          <h1 className='text-3xl sm:text-6xl font-semibold 
          sm:leading-16 text-gray-700'>your own <span className='text-primary' >blogging</span><br/> platfrom</h1>
          ...
          <p className='my-6 sm:my-8 max-w-2xl m-auto max-sm:text-xs text-gray-500 '>This is your space to think out loud, to share what matters,
             and to write without filters. Whether its's one word or a thousand, 
